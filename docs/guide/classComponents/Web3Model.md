...
<h3 align="center">
Basic contract method and Web3 basic method integration
</h3>

## 🎉 Preview

<h1 align="center">
    <img :src="$withBase('/img/classComponents/digi-web3-model/digi-web3-model.png')" alt="logo">
</h1>
...
<template>
  <div class="warp">
    <div v-show="provider === ''">
      <digi-button class="cl-btu" type="primary" @click="handleClickConnect()"
        >Connect</digi-button
      >
    </div>
    <div v-show="provider">
      ...
      <digi-button
        class="cl-btu"
        type="warning"
        @click="handleClickGetBalanceOf()"
        >GetBalanceOf</digi-button
      >
    </div>
...
export default {
  ...
  methods: {
    ...
    async handleClickGetBalanceOf() {
      var web3ModelObj = await new this.$Web3Model(
        this.provider,
        Web3,
        CHAINID,
        this.contractAdress,
